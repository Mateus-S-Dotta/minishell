...
/*   Updated: 2025/04/17 15:38:43 by lsilva-x         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**builtins_arr(void)
{
	...
	btarr[3] = ft_strdup("env");
	btarr[4] = ft_strdup("cd");
	btarr[5] = ft_strdup("export");
	btarr[6] = ft_strdup("unset");
	btarr[7] = ft_strdup("exit");
	btarr[8] = NULL;
